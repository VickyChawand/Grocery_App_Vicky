...
import com.vicky.grocery_app_vicky.databinding.PreviousOrderCardBinding
import com.vicky.grocery_app_vicky.dataclasses.PreviousOrder
...
class PreviousOrdersAdapter( private val items: MutableList<PreviousOrder>) : RecyclerView.Adapter<PreviousOrdersAdapter.TaskViewHolder>() {
    class TaskViewHolder(val binding: PreviousOrderCardBinding) :
        RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TaskViewHolder {
        return TaskViewHolder(
            PreviousOrderCardBinding.inflate(
